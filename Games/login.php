...
<br/>
In the game, you will be given 30 chances to accumulate your reward. In each game shot, you can chose only one gate to open, no matter how many gates you could choose from. Your chance of successfully win the treasure in each game shot is independent from all the other game shots. We won’t tell you the result of the game until you finish all the 30 games. This is mainly because we don’t want you to change your risk-attitude while playing the game, which is very important to our research. But we do keep record of each game and will show you detailed information about your performance over all the games in the end.
<br/>
<br/>
<!--table>
<tr>
