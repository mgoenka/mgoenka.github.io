...
<table align="center" cellspacing="10" cellpadding="50" bgcolor="black">
    <tr bgcolor = #3b9c9c align="center" style="font-size: x-large">
        <th>Gates</th>
        ...
        <th>Gate 6<br/><Input type="radio" name="gate" value="3"/></th>
        <th>Gate 7<br/><Input type="radio" name="gate" value="4"/></th>
        <th>Gate 8<br/><Input type="radio" name="gate" value="5"/></th>
    </tr>
<?php } ?>

<?php if (($_SESSION['counter'] == 0) || ($_SESSION['counter'] == 1)) { ?>
    <tr align="center">
        <td bgcolor = #555555 align="left" style="font-size: x-large">Your Rewards</td>
        <td valign="bottom">4<br/><img src="Images/w10.jpg"></td>
        <td valign="bottom">3<br/><img src="Images/w8.jpg"></td>
        <td valign="bottom">5<br/><img src="Images/w3.jpg"></td>
        <td valign="bottom">5<br/><img src="Images/w7.jpg"></td>
        <td valign="bottom">7<br/><img src="Images/w6.jpg"></td>
        <td valign="bottom">5<br/><img src="Images/w7.jpg"></td>
        <td valign="bottom">5<br/><img src="Images/w8.jpg"></td>
        <td valign="bottom">7<br/><img src="Images/w2.jpg"></td>
    </tr>
    <tr align="center">
        <td bgcolor = #555555 align="left" style="font-size: x-large">Your Penalties</td>
        <td valign="top"><img src="Images/l7.jpg"><br/>-6</td>
        <td valign="top"><img src="Images/l4.jpg"><br/>-6</td>
        <td valign="top"><img src="Images/l6.jpg"><br/>-5</td>
        <td valign="top"><img src="Images/l8.jpg"><br/>-4</td>
        <td valign="top"><img src="Images/l4.jpg"><br/>-10</td>
        <td valign="top"><img src="Images/l2.jpg"><br/>-5</td>
        <td valign="top"><img src="Images/l9.jpg"><br/>-4</td>
        <td valign="top"><img src="Images/l3.jpg"><br/>-10</td>
    </tr>
<?php } ?>

<?php if ($_SESSION['counter'] == 0) { ?>
    <tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: x-large">
...
<?php if (($_SESSION['counter'] == 0) || ($_SESSION['counter'] == 1)) { ?>
    <tr align="center" style="font-size: x-large">
        <td bgcolor = #555555 align="left" >Guards' Rewards</td><td>10</td><td>8</td><td>3</td><td>7</td><td>6</td><td>7</td><td>8</td><td>2</td>
    </tr>
    <tr align="center" style="font-size: x-large">
        <td bgcolor = #555555 align="left" >Guards' Penalties</td><td>-7</td><td>-4</td><td>-6</td><td>-8</td><td>-4</td><td>-2</td><td>-9</td><td>-3</td>
    </tr>
<?php } ?>
...
<!--
    ...
    <h2><a href="jamesgame2.php">Start Game</a></h2>
    <br/>
