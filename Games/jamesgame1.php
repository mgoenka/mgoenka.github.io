...
<?php if ($_SESSION['counter'] == 0) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
		...
		<td valign="bottom" colspan="8">[2,3,5] [2,4,5] [1,4,5] [1,2,6] [2,4,7]</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 1) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
			<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
			<td valign="bottom" colspan="8">[4,5,8]	[1,2,6]	[2,5,8]	[2,3,5]	[2,5,8]</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 2) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
				<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
				<td valign="bottom" colspan="8">[1,2,5]	[1,2,6]	[1,4,7]	[2,6,7]	[1,5,6]</td>
	</tr>

<?php } else if ($_SESSION['counter'] == 3) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
				<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
				<td valign="bottom" colspan="8">[1,3,5]	[1,6,7]	[2,3,6]	[2,4,7]	[3,5,6]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 4) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
				<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
				<td valign="bottom" colspan="8">[4,5,8]	[5,6,7]	[1,5,6]	[1,5,8]	[1,2,7]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 5) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
				<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
				<td valign="bottom" colspan="8">[1,2,5]	[1,2,4]	[5,6,7]	[1,2,5]	[1,2,5]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 6) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
				<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
				<td valign="bottom" colspan="8">[2,3,7]	[2,4,7]	[2,5,6]	[2,5,7]	[1,7,8]</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 7) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
					<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
					<td valign="bottom" colspan="8">[5,7,8]	[1,2,7]	[2,5,8]	[1,4,5]	[2,7,8]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 8) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[4,5,7]	[1,4,7]	[2,4,7]	[1,2,7]	[2,5,7]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 9) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[1,2,4]	[1,2,5]	[1,2,3]	[1,2,4]	[2,4,7]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 10) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[2,5,7]	[1,3,7]	[2,5,7]	[1,2,4]	[1,2,4]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 11) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[2,5,7]	[1,2,5]	[2,4,7]	[1,4,7]	[1,2,5]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 12) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[1,2,3]	[1,6,7]	[5,6,8]	[2,4,6]	[1,3,6]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 13) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[2,3,7]	[1,3,6]	[1,6,7]	[1,6,8]	[2,6,8]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 14) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[6,7,8]	[2,7,8]	[1,6,8]	[6,7,8]	[1,6,8]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 15) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[6,7,8]	[2,6,7]	[1,6,8]	[1,7,8]	[2,7,8]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 16) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[4,6,7]	[3,4,7]	[2,4,8]	[1,4,6]	[2,6,7]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 17) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[1,6,8]	[2,5,7]	[1,6,7]	[4,6,7]	[1,6,8]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 18) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[2,7,8]	[4,6,7]	[4,6,8]	[2,4,6]	[5,7,8]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 19) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[1,6,7]	[1,4,7]	[1,6,8]	[3,6,8]	[6,7,8]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 20) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[4,6,8]	[4,6,7]	[4,7,8]	[2,6,8]	[2,6,8]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 21) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[1,6,8]	[3,7,8]	[2,4,6]	[1,6,7]	[1,2,4]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 22) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[3,4,6]	[1,3,4]	[1,5,6]	[4,5,8]	[1,2,7]
</td>
	</tr>
<?php } else if ($_SESSION['counter'] == 23) { ?>
	<tr align="center" bgcolor="#afc7c7" style="color: #000000; font-size: large">
						<td bgcolor = "#afc7c7" align="left">Observations of Guards</td>
						<td valign="bottom" colspan="8">[2,4,6]	[4,6,8]	[3,5,8]	[1,4,7]	[1,2,6]
</td>
	</tr>
<?php } ?>
