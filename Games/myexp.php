    ...
    */
    ...
    if(!isset($_SESSION['gameid']))
    {
        ...
        if ($_SESSION['gameid'] == 1)
            ...
            $_SESSION['combo'] = array(23,16,30,9,13,5,19,31,12,2,27,35,25,29,24,22,34,4,6,18,33,32,8,1,17,14,28,15,3,20,36);
        else if ($_SESSION['gameid'] == 3)
            $_SESSION['combo'] = array(16,9,23,5,30,31,13,2,19,35,12,29,27,22,25,4,24,18,34,32,6,1,33,14,8,15,17,20,28,10,36);
        else if ($_SESSION['gameid'] == 4)
            $_SESSION['combo'] = array(9,5,16,31,23,2,30,35,13,29,19,22,12,4,27,18,25,32,24,1,34,14,6,15,33,20,8,10,17,21,36);
        else if ($_SESSION['gameid'] == 5)
            $_SESSION['combo'] = array(5,31,9,2,16,35,23,29,30,22,13,4,19,18,12,32,27,1,25,14,24,15,34,20,6,10,33,21,8,7,36);
        else if ($_SESSION['gameid'] == 6)
            $_SESSION['combo'] = array(31,2,5,35,9,29,16,22,23,4,30,18,13,32,19,1,12,14,27,15,25,20,24,10,34,21,6,7,33,26,36);
        else if ($_SESSION['gameid'] == 7)
            $_SESSION['combo'] = array(2,35,31,29,5,22,9,4,16,18,23,32,30,1,13,14,19,15,12,20,27,10,25,21,24,7,34,26,6,11,36);
        else if ($_SESSION['gameid'] == 8)
            $_SESSION['combo'] = array(35,29,2,22,31,4,5,18,9,32,16,1,23,14,30,15,13,20,19,10,12,21,27,7,25,26,24,11,34,3,36);
        else if ($_SESSION['gameid'] == 9)
            $_SESSION['combo'] = array(29,22,35,4,2,18,31,32,5,1,9,14,16,15,23,20,30,10,13,21,19,7,12,26,27,11,25,3,24,28,36);
        else if ($_SESSION['gameid'] == 10)
            $_SESSION['combo'] = array(22,4,29,18,35,32,2,1,31,14,5,15,9,20,16,10,23,21,30,7,13,26,19,11,12,3,27,28,25,17,36);
        else if ($_SESSION['gameid'] == 11)
            $_SESSION['combo'] = array(4,18,22,32,29,1,35,14,2,15,31,20,5,10,9,21,16,7,23,26,30,11,13,3,19,28,12,17,27,8,36);
        else if ($_SESSION['gameid'] == 12)
            $_SESSION['combo'] = array(18,32,4,1,22,14,29,15,35,20,2,10,31,21,5,7,9,26,16,11,23,3,30,28,13,17,19,8,12,33,36);
        else if ($_SESSION['gameid'] == 13)
            $_SESSION['combo'] = array(32,1,18,14,4,15,22,20,29,10,35,21,2,7,31,26,5,11,9,3,16,28,23,17,30,8,13,33,19,6,36);
        else if ($_SESSION['gameid'] == 14)
            $_SESSION['combo'] = array(1,14,32,15,18,20,4,10,22,21,29,7,35,26,2,11,31,3,5,28,9,17,16,8,23,33,30,6,13,34,36);
        else if ($_SESSION['gameid'] == 15)
            $_SESSION['combo'] = array(14,15,1,20,32,10,18,21,4,7,22,26,29,11,35,3,2,28,31,17,5,8,9,33,16,6,23,34,30,24,36);
        else if ($_SESSION['gameid'] == 16)
            $_SESSION['combo'] = array(15,20,14,10,1,21,32,7,18,26,4,11,22,3,29,28,35,17,2,8,31,33,5,6,9,34,16,24,23,25,36);
        else if ($_SESSION['gameid'] == 17)
            $_SESSION['combo'] = array(20,10,15,21,14,7,1,26,32,11,18,3,4,28,22,17,29,8,35,33,2,6,31,34,5,24,9,25,16,27,36);
        else if ($_SESSION['gameid'] == 18)
            $_SESSION['combo'] = array(10,21,20,7,15,26,14,11,1,3,32,28,18,17,4,8,22,33,29,6,35,34,2,24,31,25,5,27,9,12,36);
        else if ($_SESSION['gameid'] == 19)
            $_SESSION['combo'] = array(21,7,10,26,20,11,15,3,14,28,1,17,32,8,18,33,4,6,22,34,29,24,35,25,2,27,31,12,5,19,36);
        else if ($_SESSION['gameid'] == 20)
            $_SESSION['combo'] = array(7,26,21,11,10,3,20,28,15,17,14,8,1,33,32,6,18,34,4,24,22,25,29,27,35,12,2,19,31,13,36);
        else if ($_SESSION['gameid'] == 21)
            $_SESSION['combo'] = array(26,11,7,3,21,28,10,17,20,8,15,33,14,6,1,34,32,24,18,25,4,27,22,12,29,19,35,13,2,30,36);
        else if ($_SESSION['gameid'] == 22)
            $_SESSION['combo'] = array(11,3,26,28,7,17,21,8,10,33,20,6,15,34,14,24,1,25,32,27,18,12,4,19,22,13,29,30,35,23,36);
        else if ($_SESSION['gameid'] == 23)
            $_SESSION['combo'] = array(3,28,11,17,26,8,7,33,21,6,10,34,20,24,15,25,14,27,1,12,32,19,18,13,4,30,22,23,29,16,36);
        else if ($_SESSION['gameid'] == 24)
            $_SESSION['combo'] = array(28,17,3,8,11,33,26,6,7,34,21,24,10,25,20,27,15,12,14,19,1,13,32,30,18,23,4,16,22,9,36);
        else if ($_SESSION['gameid'] == 25)
            $_SESSION['combo'] = array(17,8,28,33,3,6,11,34,26,24,7,25,21,27,10,12,20,19,15,13,14,30,1,23,32,16,18,9,4,5,36);
        else if ($_SESSION['gameid'] == 26)
            $_SESSION['combo'] = array(8,33,17,6,28,34,3,24,11,25,26,27,7,12,21,19,10,13,20,30,15,23,14,16,1,9,32,5,18,31,36);
        else if ($_SESSION['gameid'] == 27)
            $_SESSION['combo'] = array(33,6,8,34,17,24,28,25,3,27,11,12,26,19,7,13,21,30,10,23,20,16,15,9,14,5,1,31,32,2,36);
        else if ($_SESSION['gameid'] == 28)
            $_SESSION['combo'] = array(6,34,33,24,8,25,17,27,28,12,3,19,11,13,26,30,7,23,21,16,10,9,20,5,15,31,14,2,1,35,36);
        else if ($_SESSION['gameid'] == 29)
            $_SESSION['combo'] = array(34,24,6,25,33,27,8,12,17,19,28,13,3,30,11,23,26,16,7,9,21,5,10,31,20,2,15,35,14,29,36);
        else if ($_SESSION['gameid'] == 30)
            $_SESSION['combo'] = array(24,25,34,27,6,12,33,19,8,13,17,30,28,23,3,16,11,9,26,5,7,31,21,2,10,35,20,29,15,22,36);
        else if ($_SESSION['gameid'] == 31)
            $_SESSION['combo'] = array(25,27,24,12,34,19,6,13,33,30,8,23,17,16,28,9,3,5,11,31,26,2,7,35,21,29,10,22,20,4,36);
        else if ($_SESSION['gameid'] == 32)
            $_SESSION['combo'] = array(27,12,25,19,24,13,34,30,6,23,33,16,8,9,17,5,28,31,3,2,11,35,26,29,7,22,21,4,10,18,36);
        else if ($_SESSION['gameid'] == 33)
            $_SESSION['combo'] = array(12,19,27,13,25,30,24,23,34,16,6,9,33,5,8,31,17,2,28,35,3,29,11,22,26,4,7,18,21,32,36);
        else if ($_SESSION['gameid'] == 34)
            $_SESSION['combo'] = array(19,13,12,30,27,23,25,16,24,9,34,5,6,31,33,2,8,35,17,29,28,22,3,4,11,18,26,32,7,1,36);
        else if ($_SESSION['gameid'] == 35)
            $_SESSION['combo'] = array(13,30,19,23,12,16,27,9,25,5,24,31,34,2,6,35,33,29,8,22,17,4,28,18,3,32,11,1,26,14,36);
        /*
...
<?php if (($_SESSION['counter'] > 1) && ($_SESSION['counter'] < $maxround)) { ?>
    <h3>You chose Gate <?php echo $gate; ?></h3>
