<?php
    ...
    if (($gate == "") || ($gate == null))
    {
        echo "<meta http-equiv='refresh' content='0;url=game11.php#GT'>";
    }
...
<?php } ?>
    ...
    <tr align="center" >
        <td bgcolor = #555555 align="left" >Probabilities</td><td>0.05</td><td>0.38</td><td>1.00</td><td>0.59</td><td>0.30</td><td>0.12</td><td>0.32</td><td>0.24</td>
    </tr>
</table>
