<?php
    ...
    if (($gate == "") || ($gate == null))
    {
        echo "<meta http-equiv='refresh' content='0;url=game12.php#GT'>";
    }
...
<?php } ?>
    ...
    <tr align="center" >
        <td bgcolor = #555555 align="left" >Probabilities</td><td>0.15</td><td>0.54</td><td>0.91</td><td>0.19</td><td>0.38</td><td>0.24</td><td>0.28</td><td>0.31</td>
    </tr>
</table>
