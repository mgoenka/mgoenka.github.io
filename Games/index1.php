...
<td>While playing the game, you will be eligible to win an Apple iPod Touch. The number of entries will be dependant upon your score, higher scores increase the number of lottery tickets received; however, you cannot win more than one iPod.<br/>
<br/>
...
<?php if (($_SESSION['counter1'] > 0) && (!isset($_SESSION['gender']))) { ?>
You did not enter your Gender.<br/>
Please enter your Gender to start playing.<br/><br/>
<?php } ?>

<?php if (($_SESSION['counter1'] > 0) && (!isset($_SESSION['country']))) { ?>
...
<input name="country" type="text" style = "width:250px"><br /><br />
<?php } ?>
